...
$(document).ready(function () {
    ...
    function showSuccess() {
        // We made it \:D/
        swal({
            title: "Esta seguro de Generar el Código de Seguimiento?",
            text: "Verifique que la persona solicitante es el Titular del Área Minera. Si se generó un código de seguimiento con anterioridad será reemplazado con este nuevo.",
            type: "warning",
