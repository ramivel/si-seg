    ...
    var constraints = {
        ...
        documentos_anexados: {
            presence: function(){
                ...
                if($('#fk_estado_tramite').children('option:selected').data('padre') == 't'){
                    if(ultimo_fk_estado_tramite_padre == $('#fk_estado_tramite').val() && ultimo_fk_estado_tramite_hijo == $('#fk_estado_tramite_hijo').val())
                        return false;
                }else if(ultimo_fk_estado_tramite_padre == $('#fk_estado_tramite').val()){
                    return false;
                }
                return true;
            }            
