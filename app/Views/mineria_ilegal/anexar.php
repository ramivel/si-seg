            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <h4 class="sub-title mt-4 mb-2">ANEXAR HOJA DE RUTA DE MINERÍA ILEGAL</h4>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Hoja de ruta a la cual se anexará * : </label>
                            <div class="col-sm-10">
                                <?php $campo = 'fk_hoja_ruta_anexada';?>
                                <select id="<?= $campo;?>" name="<?= $campo;?>" class="hoja-ruta-mineria-ilegal-ajax col-sm-12">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Motivo Anexo * : </label>
                            <div class="col-sm-10">
                                <?php
                                    $campo = 'motivo_conclusion';
