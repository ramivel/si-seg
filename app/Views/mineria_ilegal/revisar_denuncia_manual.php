                    ...
                    <div class="card-block">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <?php
                                                            ...
                                                            echo form_input(array(
                                                                ...
                                                                'type' => 'number',
                                                                'class' => 'form-control form-control-uppercase',
                                                                'value' => set_value($campo, (isset($n_correlativo_hr) ? $n_correlativo_hr : ''))
                                                            ));
                                                        ?>
                                                        <span class="messages"></span>
                                                        <?php if(isset($validation) && $validation->hasError($campo)){?>
                                                    ...
                                                    <div class="col-sm-5">
                                                        <?php
                                                            ...
                                                            echo form_input(array(
                                                                ...
                                                                'type' => 'date',
                                                                'class' => 'form-control',
                                                                'value' => set_value($campo, (isset($hoja_ruta[$campo]) ? $hoja_ruta[$campo] : ''))
                                                            ));
                                                        ?>
                                                        <span class="messages"></span>
                                                        <?php if(isset($validation) && $validation->hasError($campo)){?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <?php
                                                            $campo = 'correlativo_fm';
                                                            echo form_input(array(
                                                                'name' => $campo,
                                                                'id' => $campo,
                                                                'type' => 'number',
                                                                'class' => 'form-control form-control-uppercase',
                                                                'value' => set_value($campo, (isset($n_correlativo_fm) ? $n_correlativo_fm : ''))
                                                            ));
                                                        ?>
                                                        <span class="messages"></span>
                                                        <?php if(isset($validation) && $validation->hasError($campo)){?>
                                                    ...
                                                    <div class="col-sm-5">
                                                        <?php
                                                            ...
                                                            echo form_input(array(
                                                                ...
                                                                'type' => 'date',
                                                                'class' => 'form-control',
                                                                'value' => set_value($campo, (isset($denuncia[$campo]) ? $denuncia[$campo] : ''))
                                                            ));
                                                        ?>
                                                        <span class="messages"></span>
                                                        <?php if(isset($validation) && $validation->hasError($campo)){?>
                                    ...
                                    <div class="tab-pane" id="derivacion" role="tabpanel">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <?php
                                                    $campo = 'fk_oficina';
                                                    echo form_dropdown($campo, $oficinas, set_value($campo, set_value($campo,(isset($hoja_ruta[$campo]) ? $hoja_ruta[$campo] : ''))), array('id' => $campo, 'class' => 'form-control'));
                                                ?>
                                                <span class="messages"></span>
                                                <?php if(isset($validation) && $validation->hasError($campo)){?>
                                                    <span class="form-bar text-danger"><?= $validation->getError($campo);?></span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 text-right">
                                <?php echo form_submit('enviar', 'APROBAR','class="btn btn-primary m-b-0"');?>
                                <button type="button" class="btn btn-danger m-b-0 archivado-denuncia">OBSERVAR</button>
                                <?php echo anchor($controlador.'listado_denuncias_manuales', 'CANCELAR',array('class' =>'btn btn-success m-b-0'));?>
                            </div>
                        </div>
                        <?= form_close();?>
