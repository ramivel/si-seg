                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group row d-none">
                            <div class="col-sm-10">
                                <?= form_input(array('type'=>'hidden','name'=>'id_hoja_ruta','id'=>'id_hoja_ruta','value'=>set_value('id_hoja_ruta', (isset($hoja_ruta['id']) ? $hoja_ruta['id'] : ''), false)));?>
                                <span class="messages"></span>
                            </div>
                        </div>
                        <div class="form-group row d-none">
                            <div class="col-sm-10">
                                <?= form_input(array('type'=>'hidden','name'=>'id_derivacion','id'=>'id_derivacion','value'=>set_value('id_derivacion', (isset($derivacion['id']) ? $derivacion['id'] : ''), false)));?>
                                <span class="messages"></span>
                            </div>
                        </div>
                        <div class="form-group row d-none">
                            <div class="col-sm-10">
                                <?= form_input(array('type'=>'hidden','name'=>'id_denuncia','id'=>'id_denuncia','value'=>set_value('id_denuncia', (isset($denuncia['id']) ? $denuncia['id'] : ''), false)));?>
                                <span class="messages"></span>
                            </div>
                        </div>
                        <div class="form-group row d-none">
                            ...
                            <div class="col-lg-12 col-xl-12">
                                ...
                                <div class="tab-content tabs card-block">
                                    ...
                                    <div class="tab-pane " id="adjuntos" role="tabpanel">
                                        ...
                                        <p><strong>Nota.</strong> Si selecciona nuevos archivos reemplazar a los actuales</p>
                                        <div class="row">
                                            <div class="col-sm-12 d-none">
                                                <div class="form-group row">
                                                    <?= form_input(array('type'=>'hidden','name'=>'id_croquis','id'=>'id_croquis','value'=>set_value('id_croquis', (isset($croquis['id']) ? $croquis['id'] : ''), false)));?>
                                                    <span class="messages"></span>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <a href="<?= base_url($croquis['adjunto']);?>" class="btn btn-inverse" target="_blank"><i class="icofont icofont-download-alt"></i> Ver</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-12 d-none">
                                                        <div class="form-group row">
                                                            <?= form_input(array('type'=>'hidden','name'=>'id_documento_externo','id'=>'id_documento_externo','value'=>set_value('id_documento_externo', (isset($documento_externo['id']) ? $documento_externo['id'] : ''), false)));?>
                                                            <span class="messages"></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <a href="<?= base_url($documento_externo['adjunto']);?>" class="btn btn-inverse" target="_blank"><i class="icofont icofont-download-alt"></i> Ver</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane " id="derivacion" role="tabpanel">
                                        <p><strong>Nota.</strong> En caso de la ventanilla única de la Oficina Nacional se debe remitir al Director(a) de la Dirección de Fiscalización, Control y Coordinación Interinstitucional, de ser una ventanilla de las Direcciones Departamentales o Regional se debe derivar al Director(a) de su Departamental o Regional.</p>
                                        <div class="form-group row">
