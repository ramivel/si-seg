                        ...
                        <div id="tabla_datos" class="row mb-1">
                            <div class="col-md-12">
                                <ul class="nav nav-tabs md-tabs " role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?= $url_minilegal;?>#tabla_datos"><strong>SEGUIMIENTO TRÁMITE</strong></a>
                                        <div class="slide"></div>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#tabla_datos"><strong>CORRESPONDENCIA EXTERNA</strong></a>
                                        <div class="slide"></div>
                                    </li>
                                </ul>
                            </div>
