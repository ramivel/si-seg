                                        ...
                                        <td class="text-center">
                                            <div class="dropdown-info dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdown-4" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                    <?php 
                                                    echo anchor($controlador.'ver/2/'.$fila['id_hoja_ruta'], 'Ver',array('class' =>'dropdown-item waves-light waves-effect'));
                                                    ...
                                                    if($fila['editar'] == 't')
                                                        echo anchor($controlador.'editar_ventanilla/'.$fila['id_hoja_ruta'], 'Editar Derivación',array('class' =>'dropdown-item waves-light waves-effect'));
                                                    ?>                                                    
                                                </div>
                                            </div>
                                        </td>
