                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <?= form_open($accion, ['id'=>'formulario']);?>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Motivo de la Anulación*:</label>
                                <div class="col-sm-10">
                                    <?php
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    <button type="button" id="aprobar" class="btn btn-primary m-b-0">APROBAR ANULACIÓN</button>
                                    <button type="button" id="rechazar" class="btn btn-warning m-b-0">RECHAZAR ANULACIÓN</button>
