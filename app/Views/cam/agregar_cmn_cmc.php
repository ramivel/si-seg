                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xl-12">
                                ...
                                <ul class="nav nav-tabs  tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#hoja_ruta" role="tab"><strong>Hoja de Ruta</strong></a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="tab-pane active" id="hoja_ruta" role="tabpanel">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select id="<?= $campo;?>" name="<?= $campo;?>" class="hoja-ruta-cmn-cmc-ajax col-sm-12">
                                                    <?php if(isset($hr_cmn_cmc)){ ?>
                                                        <option value="<?= $hr_cmn_cmc['id'];?>"><?= $hr_cmn_cmc['nombre'];?></option>
                                                    <?php }else{ ?>
                                                        <option value="">Escriba la Hoja de Ruta CMN/CMC</option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-1 col-form-label">Procedencia:</label>
                                            <div class="col-sm-5">
                                                <?php
                                                    $campo = 'procedencia';
                                                    echo form_input(array(
                                            ...
                                            <label class="col-sm-1 col-form-label">CITE Documento:</label>
                                            <div class="col-sm-5">
                                                <?php
                                                    $campo = 'cite_documento';
                                                    echo form_input(array(
                                                        'name' => $campo,
                                                        'id' => $campo,
                                                        'class' => 'form-control form-control-uppercase',
                                    ...
                                    <div class="tab-pane" id="apm" role="tabpanel">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select id="<?= $campo;?>" name="<?= $campo;?>" class="area-minera-cmn-cmc-ajax col-sm-12">
                                                    <?php if(isset($area_minera)){ ?>
                                                        <option value="<?= $area_minera['id'];?>"><?= $area_minera['nombre'];?></option>
                                                    <?php }else{ ?>
