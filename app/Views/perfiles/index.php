                                        ...
                                        <td class="text-center">
                                            <div class="dropdown-info dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdown-4" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">                                                    
                                                    <?php echo anchor('perfiles/editar/'.$fila['id'], 'Editar',array('class' =>'dropdown-item waves-light waves-effect'));?>
                                                    <?php echo anchor('perfiles/eliminar/'.$fila['id'], 'Eliminar',array('class' =>'dropdown-item waves-light waves-effect eliminar'));?>                                                    
                                                </div>
                                            </div>                                            
                                        </td>                  
                                    </tr>
