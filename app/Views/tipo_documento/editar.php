                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <?= form_open_multipart($accion, ['id'=>'formulario']);?>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Plantilla Anterior <span class="mytooltip tooltip-effect-5">
                                ...
                                <div class="col-sm-10">
                                    <?= form_hidden('adjunto_anterior', set_value('adjunto_anterior',$fila['plantilla']));?>
                                    <a href="<?= base_url($controlador.'descargar/'.$id);?>" class="btn btn-inverse" target="_blank"><i class="icofont icofont-download-alt"></i>Descargar</a>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Plantilla Nueva (.doc;.docx) <span class="mytooltip tooltip-effect-5">
                                        <span class="tooltip-item"><i class="fa fa-question-circle"></i></span>
                                        <span class="tooltip-content clearfix">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <?php foreach($perfiles as $row){?>
                                        <div class="checkbox-fade fade-in-primary">
                                            <label>
                                                <input type="checkbox" value="<?= $row['id'];?>" name="<?= $campo;?>[]" <?= set_checkbox($campo.'[]', $row['id'], in_array($row['id'], $perfiles_elegidos)); ?> />
                                                <span class="cr"><i class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <?php foreach($tramites as $row){?>
                                        <div class="checkbox-fade fade-in-primary">
                                            <label>
                                                <input type="checkbox" value="<?= $row['id'];?>" name="<?= $campo;?>[]" <?= set_checkbox($campo.'[]', $row['id'], in_array($row['id'], $tramites_elegidos)); ?> />
                                                <span class="cr"><i class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
                                                <span><?= $row['nombre'];?></span>
                                            </label>
                                        </div><br>
