            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <?php if(isset($id_estado_padre) && $id_estado_padre>0){?>
                            ...
                            <div id="estado_tramite_hijo" class="form-group row">
                                <label class="col-sm-2 col-form-label">Sub Estado*:</label>
                                <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?php
                                    $campo = 'instruccion';
                                    echo form_dropdown($campo, $instrucciones, set_value($campo, isset($instruccion)?$instruccion:""), array('id'=>$campo,'class' => 'instrucciones col-sm-12'));
                                ?>
                                <span class="messages"></span>
                                <?php if(isset($validation) && $validation->hasError($campo)){?>
                                    <span class="form-bar text-danger"><?= $validation->getError($campo);?></span>
                            ...
                            <div class="col-sm-10">
                                <?php
                                    ...
                                    echo form_textarea(array(
                                        ...
                                        'rows' => '3',
                                        'class' => 'form-control form-control-uppercase',
                                        'value' => set_value($campo,(isset($instruccion) && $instruccion=='OTRO' ? $derivacion['instruccion'] : ''),false)
                                    ));
                                ?>
                                <span class="messages"></span>
                                <?php if(isset($validation) && $validation->hasError($campo)){?>
