                                        ...
                                        <tr>
                                            <td class="text-center">
                                                ...
                                                if($fila['editar'] == 't' && $fila['estado'] == 'INGRESADO'){
                                                    echo anchor($controlador.'editar_ventanilla/'.$fila['id'], '<i class="fa fa-edit"></i> Editar',array('class' =>'btn btn-sm btn-info mb-2')).'<br>';
                                                }
                                                ?>
                                                <a href="<?= base_url($controlador.'hoja_ruta_pdf/'.$fila['id']);?>" target="_blank" class="btn btn-sm btn-warning"><i class="fa fa-print"></i> IMPRIMIR H.R.</a>
                                            </td>
