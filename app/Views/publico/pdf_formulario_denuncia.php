<table border="1" cellpadding="3" cellspacing="0">
    <tr>
        <td width="148" bgcolor="<?= $color;?>" align="right"><b>Fecha y hora de la Denuncia:</b></td>
...
<table border="1" cellpadding="3" cellspacing="0">
    ...
    <tr>
        ...
        <td width="390"><?= $denuncia['nombres'];?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?= $denuncia['documento_identidad'].' '.$denuncia['expedido'];?></td>
    </tr>
    <tr>
        <td bgcolor="<?= $color;?>" align="rigth"><b>Celular:</b></td>
        <td><?= $denuncia['telefonos'];?></td>
    </tr>
    <?php if($denuncia['email']){?>
        <tr>
...
<table border="1" cellpadding="3" cellspacing="0">
    ...
    <tr>
        ...
        <td width="390"><?= $ubicacion['departamento'];?></td>
    </tr>
    <tr>
