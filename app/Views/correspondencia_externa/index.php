                                    ...
                                    <tr>
                                        ...
                                        <?php
                                            if($campos_reales[$i]=='estado'){
                                                ...
                                                echo '<a href="'.base_url($ruta_archivos.$fila['controlador'].$fila['fk_area_minera'].'/externo/'.$fila[$campos_reales[$i]]).'" target="_blank" title="Ver Documento"><i class="feather icon-file"></i> Ver Documento</a>';
                                            }else{
