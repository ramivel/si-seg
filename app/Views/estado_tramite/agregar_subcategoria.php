                        ...
                        <?= form_open($accion, ['id'=>'formulario']);?>
                                ...
                                <div class="col-sm-10">
                                    <?php
                                        ...
                                        echo form_input(array(
                                            ...
                                            'class' => 'form-control',
                                            'readonly' => 'true',
                                            'value' => set_value($campo, $estado['nombre'])
                                        ));
                                    ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="checkbox-fade fade-in-primary">
                                        <label>
                                            <input type="checkbox" value="true" name="<?= $campo;?>" <?= set_checkbox($campo, 'true', true); ?> />
                                            <span class="cr"><i class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
                                            <span>SI</span>
                                        </label>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a href="<?= base_url($controlador.'subcategoria/'.$estado['id']);?>" class="btn btn-success m-b-0">CANCELAR</a>
                                </div>
                            </div>
                        <?= form_close();?>
                    </div>
