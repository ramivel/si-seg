                                        ...
                                        <td class="text-center">
                                            <div class="dropdown-info dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdown-4" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                    <?php echo anchor($controlador.'estado/'.$fila['id'], 'Cambiar Estado',array('class' =>'dropdown-item waves-light waves-effect'));?>
                                                    <?php echo anchor($controlador.'editar/'.$fila['id'], 'Editar',array('class' =>'dropdown-item waves-light waves-effect'));?>
                                                    <?php echo anchor($controlador.'eliminar/'.$fila['id'], 'Eliminar',array('class' =>'dropdown-item waves-light waves-effect eliminar'));?>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
