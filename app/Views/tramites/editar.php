                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <?= form_open($accion, ['id'=>'formulario']);?>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Controlador*:</label>
                                <div class="col-sm-10">
                                    <?php
                                        $campo = 'controlador';
                                        echo form_input(array(
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Tipo Hoja Ruta*:</label>
                                <div class="col-sm-10">
                                    <?php
                                        $campo = 'fk_tipo_hoja_ruta';
                                        echo form_dropdown($campo, $tipos_hr, set_value($campo, $fila[$campo]), array('class' => 'form-control'));
                                    ?>
                                    <span class="messages"></span>
                                    <?php if(isset($validation) && $validation->hasError($campo)){?>
                                        <span class="form-bar text-danger"><?= $validation->getError($campo);?></span>
