                        ...
                        <?= form_open($accion, ['id'=>'formulario']);?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                        $campo = 'departamento';
                                        echo form_dropdown($campo, $departamentos, set_value($campo), array('class' => 'form-control'));
                                    ?>
                                    <span class="messages"></span>
                                    <?php if(isset($validation) && $validation->hasError($campo)){?>
                                        <span class="form-bar text-danger"><?= $validation->getError($campo);?></span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <?php foreach($regionales as $row){?>
                                        <div class="checkbox-fade fade-in-primary">
                                            <label>
                                                <input type="checkbox" value="<?= $row;?>" name="<?= $campo;?>[]" <?= set_checkbox($campo.'[]', $row); ?> />
                                                <span class="cr"><i class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
                                                <span><?= $row;?></span>
                                            </label>
                                        </div><br>
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <?php foreach($oficinas_sincobol as $i=>$row){ ?>
                                        <div class="checkbox-fade fade-in-primary">
                                            <label>
                                                <input type="checkbox" value="<?= $i;?>" name="<?= $campo;?>[]" <?= set_checkbox($campo.'[]', $i); ?> />
                                                <span class="cr"><i class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
                                                <span><?= $row;?></span>
                                            </label>
                                        </div><br>
